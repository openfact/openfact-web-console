...
@Component({
  selector: 'openfact-settings-create-generic-keystore',
  templateUrl: './create-generic-keystore.component.html',
  styleUrls: ['./create-generic-keystore.component.scss']
})
export class CreateGenericKeystoreComponent implements OnInit {
  ...
  save(config: any) {
    ...
    this.componentService.create(Object.assign(this.form.value, { config: config })).subscribe(
      result => {
        this.toastr.success('Success! The component has been created.');
